...
def main():
    ...
    # Image folder path
    img_folder_path = r"F:\IndustrialInspectionCode\adversarial_samples\original_images\resnet50_trained_on_NEU-DET"
    assert os.path.exists(img_folder_path), "Folder '{}' does not exist".format(img_folder_path)
    img_modify_folder_path = r"F:\IndustrialInspectionCode\adversarial_samples_from_adversarially_trained_models\Li=8 \MI-FGSM\untargeted\attack_on_resnet50_trained_on_NEU-DET"
    ...
    json_path = r"F:\IndustrialInspectionCode\weights\NEU-DET\resnet50\class_indices.json"
    ...
    weights_path = r"F:\IndustrialInspectionCode\weights\PGD_adversarially_trained_models\NEU-DET\resnet50\resnet50_best_acc.pth"
