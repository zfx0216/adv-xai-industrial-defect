...
class PGD(Attack):
    def __init__(self, model, eps=8 / 255 * (2.4285 + 2.0357), alpha=1 / 255, steps=10, random_start=True):
    ...
    def forward(self, images, labels, actual_image_transform_matrix, actual_image_matrix):
        ...
        for _ in range(self.steps):
            ...
            delta[0][2] = torch.clamp(adv_images[0][2] - images[0][2], min=-0.13943, max=0.13943)
