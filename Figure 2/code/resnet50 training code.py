...
def main():
    ...
    # Set the model name
    model_name = 'resnet50'
    save_path = r'F:\IndustrialInspectionCode\weights\PGD_adversarially_trained_models\NEU-DET\resnet50'

    # Load the training dataset
    train_dataset = datasets.ImageFolder(
        root=r"F:\IndustrialInspectionCode\adversarial_training_data\resnet50\NEU-DET\train",
    ...
    pretrained_weights_path = r"E:\Desktop\weight_1000\resnet50-0676ba61.pth"
